...
public class PollDisplayPanel extends JPanel
{
  ...
  public static void main(String[] args) {
    PollDisplayPanel pdp = new PollDisplayPanel("A", "B", "C");
//    pdp.vote1();
//    pdp.vote2();
//    pdp.vote2();
//    System.out.println(pdp.toString());
  ...
  public String toString(){
    String returnString = String.format("%s : %d    %s : %d    %s : %d", name1, count1, name2, count2, name3, count3);
    return returnString;
  }
  ...
  private void drawPieChart(Graphics g, int x, int y, int r)
  {
    ...
    if (total > 0)
    {
      ...
      System.out.println(redDegrees);
      fromDegree += redDegrees;

      int greenDegrees;
      g.setColor(Color.GREEN);
      greenDegrees = countToDegrees(count2, total);
      drawSector(g, x, y, r, fromDegree, greenDegrees);
      System.out.println(greenDegrees);
      fromDegree += greenDegrees;

      int blueDegrees;
      g.setColor(Color.BLUE);
      blueDegrees = Math.max(total - fromDegree, 0);
      System.out.println(blueDegrees);
