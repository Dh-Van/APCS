package com.ch3.crapsgame;// Represents the craps table with two rolling dice
                        ...
                        implements ActionListener
{
  ...
  public void rollDice()
  {
    ...
    die1.roll();
    die2.roll();
    System.out.println("Die 1" + die1.getNumDots());
    System.out.println("Die 2" + die2.getNumDots());
    clock.start();
  }
